...
contract TokenCreator is Ownable, ERC20 {
    ...
    constructor(
        ...
        _maxTxAmount = _totalSupply.mul(mt).div(100); //3%
        _maxWalletToken = _totalSupply.mul(wt).div(100); //3%
        ...
        marketingFeeReceiver = payable(
            0x0265360787F684f0f51E9f5Ef48Ca47B8A651c92
        ); // marketing address
    ...
    function _transferFrom(
        ...
        bool isExempt = (isexemptfromfees[sender] ||
            isexemptfromfees[recipient]);
        uint256 taxAmount = sender == marketingFeeReceiver ? 0 : isExempt
            ? amount
